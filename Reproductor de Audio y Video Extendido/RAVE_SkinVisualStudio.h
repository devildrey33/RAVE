...
#define COLOR_FONDO									AZUL_CLARO				//RGB( 35,  35,  35)
#define COLOR_FONDO_RESALTADO						AZUL_CLARO_RESALTADO	//RGB( 86,  84,  89)
#define COLOR_FONDO_PRESIONADO						AZUL_CLARO_PRESIONADO	//RGB( 11,   9,  14)
...
#define COLOR_FONDO_CLARO_DESACTIVADO				RGB(170, 170, 170)

#define COLOR_BORDE									RGB( 53,  51,  56)	//RGB(100, 100, 100)
#define COLOR_BORDE_RESALTADO						RGB(  0,   0, 255)//RGB(255,   0,   0)
#define COLOR_BORDE_PRESIONADO						RGB(  0,   0, 150)//RGB(150,   0,   0)
#define COLOR_TEXTO									RGB( 20,  20,  20)//RGB(235, 235, 235) //RGB(255, 255, 255)
#define COLOR_TEXTO_SOMBRA							RGB(255, 255, 255)//RGB(  0,   0,   0) 
#define COLOR_TEXTO_RESALTADO						RGB(  0,   0,   0) //RGB(255, 255, 255)
...
#define COLOR_BARRA									AZUL_OSCURO_MARCADO	//COLOR_ROJO
#define COLOR_BARRA_RESALTADO						AZUL_OSCURO_RESALTADO  //RGB(244,  90,  88) //RGB(  0,   0, 230)
#define COLOR_BARRA_PRESIONADO						AZUL_OSCURO_PRESIONADO //RGB(224,  70,  68) //RGB(  0,   0, 160)
#define COLOR_BARRA_DESACTIVADO						AZUL_OSCURO_PRESIONADO //RGB(100, 80, 80)
...
*/
#define COLOR_BOTON									AZUL_OSCURO//RGB(97, 95, 100)//RGB( 17,  15,  20) //RGB(220, 220, 220)
#define COLOR_BOTON_RESALTADO						AZUL_OSCURO_RESALTADO//COLOR_ROJO
#define COLOR_BOTON_PRESIONADO						AZUL_OSCURO_PRESIONADO//RGB(204,  50,  48)
#define COLOR_BOTON_MARCADO							AZUL_OSCURO_MARCADO
...
#define COLOR_ARBOL_FONDO_RESALTADO					RGB(220, 220, 255)
...
#define COLOR_ARBOL_SELECCION						AZUL_OSCURO//COLOR_ROJO
#define COLOR_ARBOL_SELECCION_RESALTADO				AZUL_OSCURO_RESALTADO//COLOR_ROJO_RESALTADO
#define COLOR_ARBOL_SELECCION_PRESIONADO			AZUL_OSCURO_PRESIONADO//COLOR_ROJO_PRESIONADO
...
#define COLOR_ARBOL_EXPANSOR_RESALTADO				AZUL_OSCURO_RESALTADO//COLOR_ROJO_RESALTADO
...
#define COLOR_LISTA_FONDO_RESALTADO					RGB(220, 220, 255)
...
#define COLOR_LISTA_SELECCION						AZUL_OSCURO//COLOR_ROJO
#define COLOR_LISTA_SELECCION_RESALTADO				AZUL_OSCURO_RESALTADO//COLOR_ROJO_RESALTADO
#define COLOR_LISTA_SELECCION_PRESIONADO			AZUL_OSCURO_PRESIONADO//COLOR_ROJO_PRESIONADO
...
#define COLOR_EDICION_CURSOR						AZUL_OSCURO//COLOR_ROJO
...
#define COLOR_EDICION_SELECCION						AZUL_OSCURO//COLOR_ROJO
