...
namespace DWL {
	...
	enum DEdicionTexto_Tipo {
		...
		DEdicionTexto_Tipo_Arbol_Texto					= 4, //   Combobox (label + arbol) que acepta texto
		DEdicionTexto_Tipo_ArbolEdit_Texto				= 5, //   Combobox (edit + arbol) que acepta cualquier carácer
		DEdicionTexto_Tipo_Arbol_Path					= 6, //   Combobox (label + arbol) que muestra un arbol de directorios
		DEdicionTexto_Tipo_ArbolEdit_Path				= 7, //   Combobox (edit + arbol) que muestra un arbol de directorios
