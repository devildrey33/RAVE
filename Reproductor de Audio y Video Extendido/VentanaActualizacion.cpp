...
void VentanaActualizacion::Crear(const wchar_t *Version) {
	CrearVentana(NULL, L"RAVE_Actualizacion", L"Actualización", 100, 100, 570, 140, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU);
...
void VentanaActualizacion::Evento_BotonEx_Mouse_Click(DWL::DEventoMouse &DatosMouse) {
