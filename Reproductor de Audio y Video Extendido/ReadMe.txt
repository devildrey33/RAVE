========================================================================
    APLICACIÓN DE WIN32: Reproductor de Audio y Video Extendido Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Reproductor de Audio y Video Extendido.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Reproductor de Audio y Video Extendido.


Reproductor de Audio y Video Extendido.vcxproj
...
Reproductor de Audio y Video Extendido.vcxproj.filters
...
Reproductor de Audio y Video Extendido.ico
    Éste es un archivo de icono, que se utiliza como el icono de la aplicación (32x32). Este icono está incluido en el archivo principal de recursos Reproductor de Audio y Video Extendido.rc.

small.ico
    Este es un archivo de icono, que contiene una versión menor (16x16) del icono de la aplicación. Este icono está incluido en el archivo principal de recursos Reproductor de Audio y Video Extendido.rc.

/////////////////////////////////////////////////////////////////////////////
Otros archivos estándar:

StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Reproductor de Audio y Video Extendido.pch y un archivo de tipos precompilados llamado StdAfx.obj.
