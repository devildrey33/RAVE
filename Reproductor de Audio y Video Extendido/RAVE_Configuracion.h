...
// Versión y titulo
#define RAVE_VERSION			0.320f
#define RAVE_TITULO				L"Rave 0.320"
...
// Simula el path en la raíz de la aplicación en vez de en el directorio DEBUG (Solo se aplica a versiones DEBUG)
//#define RAVE_SIMULAR_PATH_DEBUG